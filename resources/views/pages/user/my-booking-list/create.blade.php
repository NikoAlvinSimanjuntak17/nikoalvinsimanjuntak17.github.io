  ...
  @component('components.form')
    ...
    @slot('input_form')
      ...
      @component('components.input-field')
          ...
          @slot('input_type', 'time') <!-- Changed to time -->
          @slot('input_id', 'start_time')
          @slot('input_name', 'start_time')
          @slot('placeholder', 'HH:mm')
          @slot('input_classes', 'timepicker') <!-- You may want to remove this if you use native time input -->
          @slot('form_group_class', 'col required')
          @slot('other_attributes', 'required onclick="this.showPicker();"') <!-- Add onclick event -->
      @endcomponent
