...
@component('components.datatables')
  ...
  @slot('buttons')
    <a href="{{ route('my-booking-list.create') }}" class="btn btn-primary" style="background-color: #265489"> <i class="fas fa-plus"></i>&nbsp;Booking</a>
  <a href="{{ route('room-list.index') }}" class="btn btn-primary" style="background-color: #265489"> <i class="fas fa-eye"></i>&nbsp;Lihat Ruangan</a>
@endslot
  @slot('table_header')
    <tr>
      <th>#</th>
