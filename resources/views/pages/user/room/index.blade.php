...
@push('after-script')
  ...
  $(document).ready(function() {
    ...
    render: function (data, type, row) {
      let bgColor = '';
      let textColor = '';
      let bookingTime = row.booking_time ? ` (${row.booking_time})` : ''; // Append booking time if available
      ...
      switch (data) {
        ...
        case 'MAINTENANCE':
          ...
          break;
        default:
          bgColor = 'bg-light';   // Default light color
          textColor = '';
      }
      return `<span class="badge ${bgColor} ${textColor}">${data}${bookingTime}</span>`;
    }
  },
      {
        name: 'description',
